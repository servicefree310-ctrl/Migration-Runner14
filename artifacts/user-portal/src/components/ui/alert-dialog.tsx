...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    ...
    style={{ background: "rgba(2,6,18,0.88)", backdropFilter: "blur(8px)" }}
    {...props}
    ref={ref}
  />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      style={{ background: "linear-gradient(145deg,#0d1424 0%,#111827 100%)", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 25px 60px rgba(0,0,0,0.75), 0 0 0 1px rgba(255,255,255,0.04)" }}
      {...props}
    />
  </AlertDialogPortal>
))
